...
def create_product_image(data: ProductImageCreate, db: Session = Depends(get_db), current_user=Depends(get_current_user)):
...
def update_product_image(data: ProductImageUpdate, db: Session = Depends(get_db), current_user=Depends(get_current_user)):
...
def delete_product_image(product_image_id: int, db: Session = Depends(get_db), current_user=Depends(get_current_user)):
